package com.benwunet.easeui.adapter;
...
public class EaseAdapterDelegatesManager {
    ...
    public EaseAdapterDelegatesManager addDelegate(EaseAdapterDelegate<?, ?> delegate, String tag) {
        ...
        if(superclass instanceof ParameterizedType) {
            ...
            delegates.put(viewType, (EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder>) delegate);
    ...
    public EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> getDelegate(int viewType) {
        EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = delegates.get(viewType);
        if(delegate == null) {
    ...
    public List<EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder>> getAllDelegates() {
        List<EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder>> list = new ArrayList<>();
    ...
    public EaseBaseRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = getDelegate(viewType);
        if(delegate == null) {
    ...
    public int getItemViewType(Object item, int position) {
        ...
        for (int index : indexList) {
            EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = delegates.get(index);
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = getDelegate(holder.getItemViewType());
        if(delegate != null) {
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        for(int i = 0; i < delegates.size(); i++) {
            EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = delegates.get(i);
            if(delegate != null) {
        ...
        if(item instanceof EMMessage) {
            if(!delegates.isEmpty()) {
                ...
                for(int i = 0; i < delegates.size(); i++) {
                    ...
                    EaseAdapterDelegate<Object, EaseBaseRecyclerViewAdapter.ViewHolder> delegate = delegates.get(key);
