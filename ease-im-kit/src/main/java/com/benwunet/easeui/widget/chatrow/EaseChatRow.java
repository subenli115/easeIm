...
import com.benwunet.easeui.modules.chat.model.EaseChatSetStyle;
...
import com.benwunet.easeui.adapter.EaseBaseAdapter;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        ...
        onInflateView();
        dynamicLayout = findViewById(R.id.ll_dynamic);
        companyLayout = findViewById(R.id.ll_company);
    ...
    private void setClickListener() {
        ...
        if(bubbleLayout != null){
            ...
            if(dynamicLayout != null) {
                ...
                dynamicLayout.setOnClickListener(new OnClickListener() {
