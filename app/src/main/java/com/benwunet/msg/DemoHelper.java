...
import com.benwunet.easeui.delegate.EaseCustomAdapterDelegate;
import com.benwunet.easeui.delegate.EaseExpressionAdapterDelegate;
import com.benwunet.easeui.delegate.EaseFileAdapterDelegate;
import com.benwunet.easeui.delegate.EaseImageAdapterDelegate;
import com.benwunet.easeui.delegate.EaseLocationAdapterDelegate;
import com.benwunet.easeui.delegate.EaseTextAdapterDelegate;
import com.benwunet.easeui.delegate.EaseVideoAdapterDelegate;
import com.benwunet.easeui.manager.EaseMessageTypeSetManager;
import com.benwunet.easeui.provider.EaseEmojiconInfoProvider;
import com.benwunet.easeui.provider.EaseSettingsProvider;
...
import com.benwunet.msg.common.utils.FetchUserInfoList;
import com.benwunet.msg.common.utils.FetchUserRunnable;
...
import com.benwunet.msg.section.chat.delegates.ChatUserCardAdapterDelegate;
...
import com.benwunet.easeui.delegate.EaseVoiceAdapterDelegate;
...
import com.benwunet.easeui.model.EaseNotifier;
...
public class DemoHelper {
    ...
    private void InitCallKit(Context context){
        ...
        //设置声网AgoraAppId
        callKitConfig.setAgoraAppId("0b8088e7ae5940ca94685f49e81926cc");
    ...
    public EaseUser getUserInfo(String username) {
        ...
        EaseUser user = null;
//        EaseUser easeUser = DemoDbHelper.getInstance(context).getUserDao().loadUserById(username);
//        if(easeUser!=null){
//
//            if(StringUtils.equals(easeUser.getUsername(),PreferenceManager.getInstance().getCurrentUserMemberId())){
//                if(!StringUtils.equals(PreferenceManager.getInstance().getCurrentUserAvatar(),easeUser.getAvatar())){
//                    EmUserEntity entity = new EmUserEntity(easeUser.getUsername());
//                    entity.setAvatar(PreferenceManager.getInstance().getCurrentUserAvatar());
//                    entity.setNickname(PreferenceManager.getInstance().getCurrentUserNick());
//                    entity.setMobile(easeUser.getMobile());
//                    DemoDbHelper.getInstance(context).getUserDao().insert(entity);
//                    return entity;
//                }
//            }
//        }
