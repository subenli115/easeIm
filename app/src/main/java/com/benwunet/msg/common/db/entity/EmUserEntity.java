...
public class EmUserEntity extends EaseUser {
    ...
    public static EmUserEntity parseParent(EaseUser user) {
        ...
        entity.setPositionName(user.getPositionName());
        entity.setMobile(user.getMobile());
        entity.setBelong(user.getBelong());
        entity.setOrgType(user.getOrgType());
        entity.setIsTemporary(user.getIsTemporary());
        entity.setStyleId(user.getStyleId());
